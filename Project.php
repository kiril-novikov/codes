...
class Project extends MY_Controller
{
    ...
    public function getProjectsAction($task = 0) {
        ...
        if(1 == $key) {
            ...
            $users = $this->user_model->getUsers('user.team_id = '.$this->session->user_info['id'].' or user.id = '.$this->session->user_info['id']);
            $response = $this->project_model->getTeamProjects($this->session->user_info['id']);
        } elseif(3 == $key) {
            $users = $this->user_model->getUsers('user.id = '.$this->session->user_info['id']);
    ...
    */
    ...
    public function deleteProjectAction($id) {
        ...
        $response = $this->project_model->deleteProjects([$id]);
